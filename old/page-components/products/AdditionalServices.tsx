          ...
          {services.map((service, index) => {
            ...
            return (
              <li className={classNames(isLast ? "" : "pb-4")} key={index}>
                <FadeIn
                  from={-5}
                  className="flex gap-1 font-heading text-2xl font-extrabold leading-tight lg:leading-tight"
                >
                  <span className="text-greenDark-11">-</span>
                  <div className="ml-2">
                    <h3 className="mb-1 lg:mb-2">{service.heading}</h3>
                    <p className="font-body text-base font-normal leading-tight text-slateDark-11 lg:text-lg lg:leading-tight">
                      {service.subHeading}
                    </p>
                  </div>
                </FadeIn>
