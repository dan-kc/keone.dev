    ...
    <section className='pt-16 md:pt-20 relative bg-anthracite-3'>
      <Container size={Options.md}>
          ...
          <article className=''>
            ...
            <p className='sm:pr-4 md:pr-8 lg:pr-12 xl:pr-16'>
              A landing page should range from around <Em>£4,800</Em> to{' '}
              <Em>£6,700</Em> and take <Em>roughly 6 weeks,</Em> but, similar to
              the portfolio website, price and timeframe may vary depending on
              the scope of the animations implemented.
            </p>
          </article>
        </div>
      </Container>
